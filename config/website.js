...
module.exports = {
  ...
  minibio: `
      <strong>Marcus Wood</strong> is a JavaScript software engineer that focuses on building enterprise products using Typescript, React, and Node. He has built and delivered solutions for some of the largest companies in the world.
    `,
